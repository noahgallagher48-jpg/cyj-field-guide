...
- Intake: unorganized notes to noah@abba-photo.com (subject "CYJ guide note") + Judy's ten-tap questionnaire (answers arrive by email, subject "CYJ guide: questionnaire answers"). Fold both into guide revisions; new PDF versions publish to the same field-guide URL.
